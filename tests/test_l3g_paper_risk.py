...
class PaperRiskTests(unittest.TestCase):
    ...
    def test_freshness_session_stop_slippage_and_max_age(self) -> None:
        ...
        aged = replace(healthy_snapshot(), position_opened_at="2026-08-24T13:51:00Z")
        self.assertTrue(authority.maximum_age_due(aged, AT))
        self.assertFalse(authority.maximum_age_due(replace(healthy_snapshot(), position_opened_at="2026-08-24T13:51:00.000001Z"), AT))
